...
{
    /**
     * Cut-over snapshot migration that preserves historical MySQL-specific
     * schema details for fresh OpenCATS installs.
     */
...
SQL169
    ...
    {
        throw new RuntimeException('The initial OpenCATS schema migration is not reversible.');
    }
}
