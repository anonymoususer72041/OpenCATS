...
<html>
    <head>
        ...
        <script type="text/javascript" src="<?php echo call_user_func(array('TemplateUtility', 'getVersionedAssetURL'), 'vendor/components/jquery/jquery.min.js'); ?>"></script>
        <script type="text/javascript" src="<?php echo call_user_func(array('TemplateUtility', 'getVersionedAssetURL'), 'vendor/twbs/bootstrap/dist/js/bootstrap.min.js'); ?>"></script>
    </head>
    <body>
        <div class="container">
            <div class="row">
