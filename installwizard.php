...
<html>
    <head>
        ...
        <script type="text/javascript" src="<?php echo call_user_func(array('TemplateUtility', 'getVersionedAssetURL'), 'js/lib.js'); ?>"></script>
        <script type="text/javascript" src="<?php echo call_user_func(array('TemplateUtility', 'getVersionedAssetURL'), 'js/install.js'); ?>"></script>
        <script type="text/javascript" src="<?php echo call_user_func(array('TemplateUtility', 'getVersionedAssetURL'), 'js/submodal/subModal.js'); ?>"></script>
