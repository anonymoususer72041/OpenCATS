...
class Encryption
{
    private $_cipher = false;
    private $_key = '';
    private $_iv = '';
    private $_blockSize = 16;
    private $_useZeroPadding = true;
    ...
    private function _resolveCipher($algorithm, $mode)
    {
    ...
    private function _resolveKeyLength($cipher)
    {
    ...
    private function _resolveBlockSize($cipher)
    {
    ...
    private function _shouldUseZeroPadding($mode)
    {
        $mode = strtolower((string) $mode);
