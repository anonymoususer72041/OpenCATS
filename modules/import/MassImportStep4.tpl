    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            ...
            <td width="45%" valign="top">
                ...
                <span color="green"><?php echo count($this->importedCandidates); ?></span> Candidate<?php echo count($this->importedCandidates) != 1 ? 's' : ''; ?> Imported
                </span>
                <p />
                ...
                <p />
                <strong>Imported Candidates:</strong>
            ...
            <td <?php if (LicenseUtility::isParsingEnabled()): ?>width="45%" <?php endif; ?>valign="top">
                <span style="font-size: 18px; font-weight: bold;">
                <span color="blue"><?php echo count($this->importedDocuments); ?></span> Resume Document<?php echo count($this->importedDocuments) != 1 ? 's' : ''; ?> Saved
                </span>
                <p />
                ...
                <p />
                <strong>Resume Documents:</strong>
                <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #F8FAFF; padding: 10px; border: 1px solid #A5BAE9;">
        ...
        <tr>
            <td colspan="3" valign="top" style="padding-top: 20px;">
                <br /><br />
                <span style="font-size: 18px; font-weight: bold;">
                <span color="red"><?php echo count($this->importedFailed); ?></span> Document<?php echo count($this->importedFailed) != 1 ? 's' : ''; ?> Failed to be Imported
                </span>
                <p />
