...
<head>
    ...
    <link rel="stylesheet" href="<?php echo (new TemplateUtility())->getVersionedAssetURL('modules/wizard/style.css'); ?>" type="text/css" />
    <script type="text/javascript" src="<?php echo (new TemplateUtility())->getVersionedAssetURL('modules/wizard/wizard.js'); ?>"></script>
    <?php if ($this->jsInclude != ''): ?>
    <script type="text/javascript" src="<?php echo (new TemplateUtility())->getVersionedAssetURL($this->jsInclude); ?>"></script>
    <?php endif; ?>
