    ...
    <div id="main">
        ...
        <div id="contents">
            ...
            <table class="sortable">
                ...
                <?php if (!empty($this->contactsRSWC) && is_array($this->contactsRSWC) && count($this->contactsRSWC) != 0): ?>
               ...
               <?php endif; ?>
                ...
                <?php
                if (
                    !empty($this->contactsRSWC) && is_array($this->contactsRSWC) &&
                    !empty($this->contactsRS) && is_array($this->contactsRS) &&
