...
class CompaniesListByViewDataGrid extends CompaniesDataGrid
{
    ...
    public function getInnerActionArea()
    {
        ...
        $html .= $this->getInnerActionAreaItemPopup('Add To List', (new CATSUtility())->getIndexName().'?m=lists&amp;a=addToListFromDatagridModal&amp;dataItemType='.DATA_ITEM_COMPANY, 450, 350);
...
class companiesSavedListByViewDataGrid extends CompaniesDataGrid
{
    ...
    public function getInnerActionArea()
    {
        ...
        $html .= $this->getInnerActionAreaItemPost('Remove From This List', (new CATSUtility())->getIndexName().'?m=lists&amp;a=removeFromListDatagrid&amp;dataItemType='.DATA_ITEM_COMPANY.'&amp;savedListID='.$this->getMiscArgument(), false);
        $html .= $this->getInnerActionAreaItem('Export', (new CATSUtility())->getIndexName().'?m=export&amp;a=exportByDataGrid');
