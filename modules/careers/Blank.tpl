...
<html>
    <head>
        ...
        <title><?php $this->_($this->siteName); ?> - Careers</title>
            <script type="text/javascript" src="<?php echo '../' . (new TemplateUtility())->getVersionedAssetURL('js/careerPortalApply.js'); ?>"></script>
        <?php global $careerPage; if (isset($careerPage) && $careerPage == true): ?>
            ...
            <script type="text/javascript" src="<?php echo '../' . (new TemplateUtility())->getVersionedAssetURL('js/sorttable.js'); ?>"></script>
            <script type="text/javascript" src="<?php echo '../' . (new TemplateUtility())->getVersionedAssetURL('js/calendarDateInput.js'); ?>"></script>
        <?php else: ?>
            <script type="text/javascript" src="<?php echo (new TemplateUtility())->getVersionedAssetURL('js/lib.js'); ?>"></script>
            <script type="text/javascript" src="<?php echo (new TemplateUtility())->getVersionedAssetURL('js/sorttable.js'); ?>"></script>
            <script type="text/javascript" src="<?php echo (new TemplateUtility())->getVersionedAssetURL('js/calendarDateInput.js'); ?>"></script>
			<script type="text/javascript" src="<?php echo (new TemplateUtility())->getVersionedAssetURL('js/careersPage.js'); ?>"></script>
        <?php endif; ?>
