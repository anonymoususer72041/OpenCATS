...
<html>
    <head>
        ...
        <script type="text/javascript" src="<?php echo TemplateUtility::getVersionedAssetURL('vendor/components/jquery/jquery.min.js'); ?>"></script>
        <script type="text/javascript" src="<?php echo TemplateUtility::getVersionedAssetURL('vendor/twbs/bootstrap/dist/js/bootstrap.min.js'); ?>"></script>
