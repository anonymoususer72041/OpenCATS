...
You have <b><?php echo (new StringUtility())->cardinal($this->userLicenses); ?></b> user licenses and they have all been used.
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="informativeTable">
    <tr>
        <td align="left" valign="top" class="informativeColumn">
            ...
            You are using <b><?php echo (new StringUtility())->cardinal($this->totalUsers); ?></b> of your <b><?php echo (new StringUtility())->cardinal($this->userLicenses); ?></b> user licenses.
            <?php endif; ?>
        </td>
