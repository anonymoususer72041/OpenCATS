...
<script type="text/javascript">
    ...
    <form name="logActivityForm" id="logActivityForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=addActivityScheduleEvent<?php if($this->onlyScheduleEvent): ?>&amp;onlyScheduleEvent=true<?php endif; ?>" method="post" onsubmit="return checkActivityForm(document.logActivityForm);" autocomplete="off">
                ...
                <td class="tdData">
                    <select id="regardingID" name="regardingID" class="inputbox" style="width: 150px;">
                        ...
                        <?php foreach ($this->pipelineRS as $rowNumber => $pipelinesData): ?>
                            ...
                            <?php else: ?>
                                <option value="<?php $this->_($pipelinesData['jobOrderID']) ?>"><?php $this->_($pipelinesData['title']) ?></option>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    </select>
                </td>
    ...
    <script type="text/javascript">
        if (document.logActivityForm && document.logActivityForm.activityNote)
        {
