...
<script type="text/javascript">
    ...
    <form name="addActivityForm" id="addActivityForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=addActivity" method="post" onsubmit="return checkActivityForm(document.addActivityForm);" autocomplete="off">
        ...
        <table class="editTable" width="560">
           ...
           <tr id="addActivityTR">
                ...
                <td class="tdData">
                    <input type="checkbox" name="addActivity" id="addActivity" style="margin-left: 0px;" checked="checked" onclick="AS_onAddActivityChange('addActivity', 'activityTypeID', 'activityNote', 'addActivitySpanA', 'addActivitySpanB');" />Log an Activity<br />
            ...
            <tr id="scheduleEventTR">
                ...
                <td class="tdData">
                    <input type="checkbox" name="scheduleEvent" id="scheduleEvent" style="margin-left: 0px;" onclick="AS_onScheduleEventChange('scheduleEvent', 'scheduleEventDiv');" />Schedule Event
                    <div id="scheduleEventDiv" style="display:none;">
    ...
    <script type="text/javascript">
        document.addActivityForm.activityNote.focus();
    </script>
