...
class CATSSchema
{
    public static function get()
    {
        ...
        return [
            ...
            ',
            '101' => 'PHP:
                $db->query(\'UPDATE job_board_template SET value = REPLACE(value, "<div style="text-align:center;">", "<div style=\"text-align:center;\"><table align=\"center\"><tr><td style=\"text-align:left;\">");\');
            ',
            '102' => 'PHP:
                $db->query(\'UPDATE job_board_template SET value = REPLACE(value, "</div>", "</td></tr></table></div>");\');
            ',
            '103' => 'PHP:
                $db->query(\'UPDATE job_board_template_site SET value = REPLACE(value, "<div style="text-align:center;">", "<div style=\"text-align:center;\"><table align=\"center\"><tr><td style=\"text-align:left;\">");\');
            ',
            '104' => 'PHP:
                $db->query(\'UPDATE job_board_template_site SET value = REPLACE(value, "</div>", "</td></tr></table></div>");\');
            ',
            '105' => '
                INSERT INTO
                    candidate_source
